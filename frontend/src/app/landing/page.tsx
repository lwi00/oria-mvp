  ...
  return (
    <Reveal delay={delay} className="h-full">
      <div
        ...
        onMouseEnter={(e) => {
          (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(167,139,250,0.35)";
          (e.currentTarget as HTMLDivElement).style.background = "rgba(255,255,255,0.07)";
        }}
        onMouseLeave={(e) => {
          (e.currentTarget as HTMLDivElement).style.border = "1px solid rgba(167,139,250,0.15)";
  ...
  return (
    <Reveal delay={delay} className="flex gap-5 items-start">
      ...
      <div>
        ...
        <p className="text-[15px] leading-relaxed" style={{ color: "rgba(196,181,253,0.75)" }}>
          {desc}
        </p>
      </div>
    </Reveal>
...
function SectionHead({
  ...
  return (
    <div className="text-center mb-14">
      ...
      {desc && (
        <p
          className="text-base mt-4 max-w-[460px] mx-auto leading-relaxed"
  ...
  return (
    <div className="flex flex-col items-center gap-1.5">
      ...
      <span
        ...
        style={{ color: active ? "#c4b5fd" : "rgba(167,139,250,0.35)" }}
      >
        {label}
      </span>
    </div>
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(124,58,237,0.18) 0%, rgba(124,58,237,0.06) 40%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
        <div
      ...
      >
        ...
        <div className="flex items-center gap-6">
          <a
            href="#features"
            className="hidden sm:inline text-sm font-medium transition-colors duration-200 cursor-pointer"
            style={{ color: "rgba(196,181,253,0.7)" }}
            onMouseEnter={(e) => {
      ...
      <section className="min-h-screen flex items-center justify-center pt-24 pb-12 relative z-[1]">
        <div className="max-w-[1080px] mx-auto px-6 flex items-center gap-16 flex-wrap justify-center">
          ...
          >
            ...
            <p
              className="text-[17px] leading-[1.75] mb-9 max-w-[430px]"
              style={{ color: "rgba(196,181,253,0.8)" }}
            >
              The crypto savings app that rewards your consistency. Hit your weekly fitness goals,
              grow your streak, and boost your yield above the{" "}
              <span className="font-semibold text-purple-300">3% baseline</span>. Challenge friends
              and save together.
            </p>
            ...
            <div className="flex gap-4 flex-wrap">
              ...
              <a
                ...
                onMouseLeave={(e) => {
                  ...
                  (e.currentTarget as HTMLAnchorElement).style.color = "rgba(196,181,253,0.85)";
                }}
              >
                How it works ↓
              </a>
            ...
            <div className="flex items-center gap-3 mt-9">
              ...
              <p className="text-[13px]" style={{ color: "rgba(196,181,253,0.6)" }}>
                <span className="font-semibold text-purple-300">Early access</span> · join the first
                runners
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(160deg, rgba(124,58,237,0.22) 0%, rgba(167,139,250,0.08) 100%)",
            ...
            >
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-[64px] leading-none font-extrabold text-white tabular-nums">
                  6
                </span>
                <span className="text-xl font-bold" style={{ color: "rgba(196,181,253,0.7)" }}>
                  weeks
                </span>
              </div>
              <div
            ...
            >
              <div className="flex justify-between items-baseline">
                ...
                <p className="text-xs tabular-nums" style={{ color: "rgba(196,181,253,0.6)" }}>
                  3/5 sessions
                </p>
              </div>
              ...
              >
                <span className="text-xs" style={{ color: "rgba(196,181,253,0.55)" }}>
                  Effective APY
                </span>
        ...
        <div className="max-w-[1080px] mx-auto px-6 flex justify-around flex-wrap gap-5">
          {[
            ...
            <div key={i} className="text-center min-w-[130px]">
              ...
              <div className="text-[13px] mt-1" style={{ color: "rgba(196,181,253,0.55)" }}>
                {s.l}
              </div>
            </div>
          ))}
        ...
        <div className="max-w-[1080px] mx-auto px-6">
          ...
          <div className="grid grid-cols-[repeat(auto-fit,minmax(270px,1fr))] auto-rows-[1fr] gap-4">
            <FeatureCard
              ...
              desc="Sign in with email, Google or Apple via Privy. A non-custodial wallet is created instantly — no seed phrase, no friction."
              delay={0}
            />
            <FeatureCard
              icon={<ZapIcon />}
              title="Pool-based yield"
              desc="A 3% baseline is guaranteed for everyone. Your activity score grows your share of a redistribution pool — the most active runners take the biggest slice."
              delay={100}
            />
            <FeatureCard
              icon={<VaultIcon />}
              title="Multi-vault on-chain"
              desc="Deposit USDC into curated Morpho vaults — Steakhouse Prime and Gauntlet on Base, Gauntlet Frontier on Ethereum. Withdraw any time."
              delay={200}
            />
            <FeatureCard
              icon={<ActivityIcon />}
              title="Strava or manual"
              desc="Connect Strava for automatic syncing of runs and rides, or log weekly km by hand. Pace is averaged within your dominant discipline."
              delay={300}
            />
            <FeatureCard
              icon={<UsersIcon />}
              title="Group challenges"
              desc="Create shared weekly goals with friends. See a collective consistency grid, weekly participation chart, and five team milestones — no APY multiplier, just real emulation."
              delay={400}
            />
            <FeatureCard
              icon={<FeedIcon />}
              title="Activity feed + reactions"
              desc="Friends' goals, streak milestones and challenge wins land on your home feed. Cheer each other with one tap; streak badges show who's on a tear."
              delay={500}
            />
          </div>
        </div>
        ...
        <div className="max-w-[1080px] mx-auto px-6 relative">
          ...
          <div className="flex flex-col gap-10 max-w-[520px] mx-auto">
            <Step
              ...
              desc="Sign in with email, Google or Apple via Privy. Pick your discipline (running, cycling, steps), set a weekly km target, optionally connect Strava."
              delay={0}
            />
            <Step
              number="2"
              title="Deposit & invest"
              desc="Fund your wallet with USDC and invest into one of three curated Morpho vaults — Steakhouse Prime or Gauntlet Prime on Base, Gauntlet Frontier on Ethereum. Withdraw whenever you want."
              delay={150}
            />
            <Step
              number="3"
              title="Stay consistent, earn more"
              desc="Meet your weekly goal to grow your streak. Each week feeds your activity score; 16 consecutive weeks fully unlock the streak component and your share of the bonus pool."
              delay={300}
            />
          </div>
        </div>
      ...
      >
        <div className="max-w-[1080px] mx-auto px-6 flex justify-between items-center flex-wrap gap-4">
          <div className="flex items-center gap-2.5">
            <span className="text-lg font-extrabold tracking-tight" style={{ color: "#a78bfa" }}>
              Oria
            </span>
            <span
