    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3 pt-1 pb-2">
        ...
        <div className="min-w-0">
          ...
          <h1 className="text-[22px] font-extrabold text-text-primary tracking-tight leading-tight">
            {title}
          </h1>
        </div>
      </div>

      {intro && <p className="text-[14px] text-text-secondary leading-relaxed">{intro}</p>}
